...
var opMap = map[string]func(t *testing.T, q *MyQueue, args string) any{
	"MyQueue": callConstruct,
	"push":    callPush,
	"peek":    callPeek,
	"pop":     callPop,
	"empty":   callEmpty,
...
func callConstruct(_ *testing.T, q *MyQueue, _ string) any {
	*q = Constructor()
	return nil
}

func callPush(t *testing.T, q *MyQueue, args string) any {
...
func callPeek(_ *testing.T, q *MyQueue, _ string) any {
	return q.Peek()
}

func callPop(_ *testing.T, q *MyQueue, _ string) any {
	return q.Pop()
}

func callEmpty(_ *testing.T, q *MyQueue, _ string) any {
	return q.Empty()
}
